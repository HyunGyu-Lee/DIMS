...
public class Toolbox {
	...
	public static WritableImage getWritableByArray(byte[] arr)
    {
    	...
    	System.out.println("��ȯ�� BufferedImage : "+bImg);
    	if (bImg != null)
        {
    	...
    	System.out.println("��ȯ�� WritableImage : "+wr);
        return wr;
    }
	...
	public static String getWhereStringBetweenDate(java.util.Date begin, java.util.Date end, String format)
	{
		...
		wStr.append("�Ͻ� between'").append(begin.toString()).append(" 00:00:00' and '").append(end.toString()).append(" 23:59:59'");
	...
	public static String getWhereStringBetweenDate(String begin, String end)
	{
		...
		wStr.append("�Ͻ� between'").append(begin).append(" 00:00:00' and '").append(end).append(" 23:59:59'");
